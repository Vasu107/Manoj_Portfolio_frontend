...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DklGnz0a.mjs");
...
var manifest = { "1ac20e83585a55e943670fa4670b07889b610801a7a21f28dc367c19f92e50fd": {
	...
	importer: () => import("./contact.functions-DxISSd8U.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CKYCH6_b.mjs").then((n) => n.t),
